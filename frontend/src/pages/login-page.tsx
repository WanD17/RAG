    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative animate-fade-up">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-2">Sign in to <span className="gradient-text font-semibold">KnowledgeRAG</span></p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-strong gradient-border rounded-2xl p-7 space-y-5 shadow-2xl shadow-black/40">
          ...
          >
            {isLoading ? 'Signing in...' : <>Sign in <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" /></>}
          </button>
        </form>
